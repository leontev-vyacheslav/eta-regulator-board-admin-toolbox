...
import 'package:flutter_test_app/components/regulator_device_list_tile/regulator_device_list_tile.dart';
...
class _HomePageState extends State<HomePage> {
  ...
  List<ListTile> _getListItems(BuildContext context) {
    var devices = RegulatorDeviceRepository(context).getList();
